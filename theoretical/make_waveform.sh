...
echo "You will be asked for some numerical input variables."
echo "If you do not wish to supply an argument, simply hit enter when prompted."
echo "*** Please enter numerical inputs ONLY. ***"
echo "What is the mass of the first black hole (solar masses)?"
read mass1
mass1=$mass1

echo "What is the mass of the other black hole (solar masses)?"
read mass2
mass2=$mass2
