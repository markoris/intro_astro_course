...
Once finished with the [activate a virtual environment step](https://packaging.python.org/en/latest/guides/installing-using-pip-and-virtual-environments/), [use the requirements file to install the required Python dependencies](https://packaging.python.org/en/latest/guides/installing-using-pip-and-virtual-environments/).
